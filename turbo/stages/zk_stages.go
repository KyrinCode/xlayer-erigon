...
func NewDefaultZkStages(ctx context.Context,
	...
	return zkStages.DefaultZkStages(ctx,
		...
		zkStages.StageZkInterHashesCfg(db, smtDB, true, true, false, dirs.Tmp, blockReader, controlServer.Hd, cfg.HistoryV3, agg, cfg.Zk),
		zkStages.StageWitnessCfg(db, smtDB, cfg.Zk, controlServer.ChainConfig, engine, blockReader, agg, cfg.HistoryV3, dirs, cfg.WitnessContractInclusion, cfg.WitnessUnwindLimit),
